...
class BBRSIHyperopt(IHyperOpt):
    ...
    def indicator_space() -> List[Dimension]:
        ...
        return [
            ...
            Categorical(['tr_bb_lower_1sd', 'tr_bb_lower_2sd',
                        'tr_bb_lower_3sd', 'tr_bb_lower_4sd'], name='buy-trigger')
        ]
        ...
        def populate_buy_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            ...
            if 'buy-trigger' in params:
                ...
                if params['buy-trigger'] == 'tr_bb_lower_4sd':
                    conditions.append(
                        dataframe['close'] < dataframe['bb_lowerband_4sd'])
    ...
    def sell_strategy_generator(params: Dict[str, Any]) -> Callable:
        ...
        def populate_sell_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            ...
            if params.get('sell-rsi-enabled'):
                conditions.append(
                    dataframe['rsi-sell'] > params['sell-rsi-value'])
